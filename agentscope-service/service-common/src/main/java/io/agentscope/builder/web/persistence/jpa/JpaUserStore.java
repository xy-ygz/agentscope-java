 ...
 *
 * <p>On first start, if the {@code builder_user} table is empty, a default {@code admin/admin}
 * user is seeded so an operator can sign in immediately after pointing the builder at a fresh
 * database. The seeded password is logged with a "change immediately" warning, matching the
 * file-mode behavior.
 *
 * <p>Wired through {@link io.agentscope.builder.web.persistence.jpa.JpaPersistenceConfig};
