...
AgentScope Java 2.0 版本尽量保持了对 1.x 版本的兼容，确保大部分用户的平滑升级；但同时 2.0 也带来了 API 层面的不兼容变更，并在核心抽象、API 和架构上均有大幅改进。完整迁移指南详见 [V1 迁移指南](/v2/zh/docs/change-log)。
...
<Card title="自进化与技能仓库" href="/v2/zh/docs/harness/skill">
...
<Card title="分层记忆管理" href="/v2/zh/docs/harness/memory">
...
<Card title="子智能体" href="/v2/zh/docs/harness/subagent">
...
<Card title="上下文自动管理" href="/v2/zh/docs/harness/compaction">
...
<Card title="复杂任务规划（Plan Mode）" href="/v2/zh/docs/harness/plan-mode">
...
<Card title="Workspace 工程底座" href="/v2/zh/docs/harness/workspace">
...
<Card title="多租户隔离" href="/v2/zh/docs/building-blocks/context">
...
<Card title="安全沙箱执行" href="/v2/zh/docs/harness/sandbox">
...
<Card title="工具权限管控" href="/v2/zh/docs/building-blocks/permission-system">
...
<Card title="优雅上下线与会话恢复" href="/v2/zh/docs/building-blocks/context">
...
<Card title="事件流式输出原生支持" href="/v2/zh/docs/building-blocks/message-and-event">
...
<Card title="更简洁的消息模型" href="/v2/zh/docs/building-blocks/message-and-event">
...
<Card title="HITL 一等公民" href="/v2/zh/docs/building-blocks/permission-system">
...
正在评估升级时间表的开发者，可以查阅 [V1 迁移指南](/v2/zh/docs/change-log) —— 拆成"必须迁移 / 推荐迁移"两层的迁移指南，加上新功能罗列，足以端到端规划一次升级。各版本具体变更请见 [Release Notes](/v2/zh/docs/others/release-notes)。

## AgentScope Service

[AgentScope Service：部署与使用](/v2/zh/service/index)
