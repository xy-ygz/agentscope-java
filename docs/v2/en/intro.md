...
<p>
Declare sub-agent specs in Markdown; the parent spawns them on demand with <code>agent&#95;spawn</code> / <code>agent&#95;send</code> in either synchronous or background mode. Background-task completion is pushed back via a <code>system-reminder</code> — no polling required.
</p>
