...
这套能力和前面提到的 [Subagents](/v2/zh/docs/harness/subagent) 模式用的是同一批 Subagent 定义，但协作方式完全不同，容易混淆，值得专门对比一下：
...
对希望进一步理解 Turn 路径、事件契约与 schema 边界的读者，我们另有一篇技术向文章：[AgentScope Service 技术解读](/v2/zh/blogs/agentscope-service-release-tech)。
