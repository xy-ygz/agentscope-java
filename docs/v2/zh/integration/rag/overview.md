...
| 扩展 | 类型 | 适合场景 |
| --- | --- | --- |
| [Simple](/v2/zh/integration/rag/simple) | 自建：embedding + 向量库 | 对接自家向量库（PgVector / Milvus / Qdrant / Elasticsearch / 内存） |
| [Bailian](/v2/zh/integration/rag/bailian) | 阿里云百炼知识库 | 用百炼托管的企业级知识库 |
| [Dify](/v2/zh/integration/rag/dify) | Dify 数据集 | 已经在 Dify 上维护知识库的场景 |
| [HayStack](/v2/zh/integration/rag/haystack) | 自托管 HayStack RAG | 已经基于 HayStack 搭建索引流水线 |
| [RAGFlow](/v2/zh/integration/rag/ragflow) | RAGFlow 服务 | 需要 OCR、知识图谱增强的复杂文档场景 |
